  ...
  <div class="w-full h-full">
    <div class="flex justify-between items-start">
      <div class="txt_bold txt-v2">
        <span>
          {{
            $t("Weather_forecast_{name}_next_{number}_days", {
              name: renderCityName,
              number: 30,
            })
          }}
...
export default {
  name: "list-30-day-page-next",
  data() {
    return {
      valueChoose: -1,
      itemsPerPage: 7, // Số mục hiển thị ban đầu
  ...
  computed: {
    ...
    displayedItems() {
      ...
      return this.currentDailyDataSeven.slice(0, end);
    },
    ...
    onClickLoadMoreItems() {
      if (this.showLessButton) {
        ...
        this.showLessButton =
          ...
          this.currentDailyDataSeven.length;
      }
    },
