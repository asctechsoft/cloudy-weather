    ...
    <div class="w-full h-full">
      <div class="w-full h-[185px]">
        <div class="w-full h-full">
          ...
          <!-- number nhiệt độ -->
          <div class="flex justify-center h-[90px] items-center">
            ...
            >
              <div class="txt_light_30 w-full flex justify-center items-center">
                {{ renderTemperature() }}
              </div>
      ...
      <div class="mt-10 flex justify-center items-end md:gap-6 gap-3">
        <!-- Image -->
...
// import SunPathGraph from "../../home/clear-day/SunPathGraph.vue";

export default {
  name: "chart-canvas-tomorrow-page",
  components: {
    SunPathPage,
  },
