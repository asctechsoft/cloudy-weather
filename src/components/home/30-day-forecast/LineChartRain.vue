<template>
  <div class="chart-container absolute btm-b">
    <div class="chart-wrapper">
      <canvas id="chart_7_day_rain" ref="canvas" height="110"></canvas>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    createChartRain() {
      const canvas = document.getElementById("chart_7_day_rain");
      if (!canvas) {
      ...
      img.onload = () => {
        ...
        pointImg.onload = () => {
          ...
          // var chart_7_day_rain = Chart.getChart("chart_7_day_rain");
